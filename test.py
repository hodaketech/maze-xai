        ...
        for episode in range(episodes):
            ...
            while not self.is_terminal(state):
                ...
                if self.is_terminal(next_state):
                    reward = 1  # reward for reaching the end
                elif next_state in self.blocked_points:
                    reward = -1  # penalty for hitting a blocked point
                else:
...
# Explanation of DRDQN
# DRDQN stands for Decomposed Reward Deep Q-Network. 
# It is an advanced reinforcement learning algorithm that improves learning efficiency by breaking down the reward signal into smaller components.
# This allows the robot to learn more effectively by understanding the consequences of its actions in a more granular way.
